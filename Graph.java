...
public class Graph
{
    ...
    private class DijkstraPair implements Comparable<DijkstraPair>
    {
        ...
        The type Graph.DijkstraPair must implement the inherited abstract method Comparable<Graph.DijkstraPair>.compareTo(Graph.DijkstraPair)
    ...
    {
        g.addVertex("Baranga");
        g.addVertex("Raghunath Pur");
        g.addVertex("KIIT Square");
        g.addVertex("Patia Square");
        g.addVertex("Damana Square");
        g.addVertex("Nalco Square");
        g.addVertex("Xavier Square");
        g.addVertex("Jaydev Vihar Square");
        g.addVertex("Kalinga Stadium");
        g.addVertex("Sastri Nagar Square");
        g.addVertex("Police Commissionerate Office");
        g.addVertex("Power House Square");
        g.addVertex("Governor House Square");
        g.addVertex("OUAT Square");
        g.addVertex("DELTA HOSPITAL SQUARE");
        g.addVertex("Fire Station");
        g.addVertex("Baramunda Bus Stand");
        g.addVertex("Jagamara Square");
        g.addVertex("Biju Patnaik International Airport");
        g.addVertex("Lingaraj Temple Road");

        g.addEdge("Baranga", "Raghunath Pur", 8);
        g.addEdge("Raghunath Pur", "KIIT Square", 10);
        g.addEdge("KIIT Square", "Damana Square", 8);
        g.addEdge("KIIT Square", "Patia Square", 6);
        g.addEdge("Patia Square", "Nalco Square", 9);
        g.addEdge("Nalco Square", "Xavier Square", 7);
        g.addEdge("Xavier Square", "Jaydev Vihar Square", 6);
        g.addEdge("Kalinga Stadium", "Sastri Nagar Square", 15);
        g.addEdge("Sastri Nagar Square", "OUAT Square", 6);
        g.addEdge("OUAT Square", "Patia Square", 7);
        g.addEdge("Patia Square", "Governor House Square", 1);
        g.addEdge("Governor House Square", "Power House Square", 2);
        g.addEdge("Power House Square", "Police Commissionerate Office", 5);
        g.addEdge("Governor House Square", "DELTA HOSPITAL Square", 2);
        g.addEdge("DELTA HOSPITAL Square", "Fire Station", 7);
        g.addEdge("Fire Station", "Baramunda Bus Stand", 8);
        g.addEdge("Nalco Square", "Jagamara Square", 2);
        g.addEdge("Lingaraj Temple Road", "Jagamara Square", 2);
        g.addEdge("Lingaraj Temple Road", "Biju Patnaik International Airport", 3);
    }
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        System.out.println("\n\t\t\t****WELCOME TO THE Bhubaneswar METRO Map*****");
